...
namespace SaburuBRZUWP
{
  ...
  public sealed partial class MainPage : Windows.UI.Xaml.Controls.Page
  {
    ...
    private Steema.TeeChart.Store.Styles.CircularGauge circularGauge1;
    ...
    private Steema.TeeChart.Store.Styles.CircularGauge circularGauge2;

    private void InitializeChart()
    {
      this.circularGauge1 = new Steema.TeeChart.Store.Styles.CircularGauge();
      ...
      this.circularGauge2 = new Steema.TeeChart.Store.Styles.CircularGauge();
      ...
      this.revChart.CurrentTheme = Steema.TeeChart.Store.ThemeType.Report;
      ...
      this.revChart.Panel.Bevel.Outer = Steema.TeeChart.Store.Drawing.BevelStyles.None;
      ...
      this.revChart.BeforeDrawSeries += new Steema.TeeChart.Store.PaintChartEventHandler(this.revChart_BeforeDrawSeries);
      ...
      this.circularGauge1.Center.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.Marks.TailParams.Align = Steema.TeeChart.Store.Styles.TailAlignment.Auto;
      ...
      this.circularGauge1.Marks.TailStyle = Steema.TeeChart.Store.Styles.MarksTail.WithPointer;
      ...
      this.circularGauge1.MinorTicks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.GreenLine.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.Hand.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.MinorTicks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.RedLine.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.TextMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge1.NumericGauge.TextMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge1.NumericGauge.TextMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.Ticks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.UnitsMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge1.NumericGauge.UnitsMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge1.NumericGauge.UnitsMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.NumericGauge.ValueMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge1.NumericGauge.ValueMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge1.NumericGauge.ValueMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.Ticks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge1.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      ...
      this.numericGauge2.TextMarker.Position = Steema.TeeChart.Store.Tools.AnnotationPositions.RightTop;
      ...
      this.numericGauge2.ColorLineStartValues.Add(0D);
      this.numericGauge2.CustomBounds = new Rect(310, 510, 150, 135);
      ...
      this.speedChart.CurrentTheme = Steema.TeeChart.Store.ThemeType.Report;
      ...
      this.speedChart.Panel.Bevel.Outer = Steema.TeeChart.Store.Drawing.BevelStyles.None;
      ...
      this.circularGauge2.Center.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.Marks.TailParams.Align = Steema.TeeChart.Store.Styles.TailAlignment.Auto;
      ...
      this.circularGauge2.Marks.TailStyle = Steema.TeeChart.Store.Styles.MarksTail.WithPointer;
      ...
      this.circularGauge2.MinorTicks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.GreenLine.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.Hand.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.MinorTicks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.RedLine.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.TextMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge2.NumericGauge.TextMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge2.NumericGauge.TextMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.Ticks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.UnitsMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge2.NumericGauge.UnitsMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge2.NumericGauge.UnitsMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.NumericGauge.ValueMarker.Callout.ArrowHead = Steema.TeeChart.Store.Styles.ArrowHeadStyles.None;
      this.circularGauge2.NumericGauge.ValueMarker.Callout.ArrowHeadDirection = Steema.TeeChart.Store.Styles.ArrowHeadDirection.FromPoint;
      ...
      this.circularGauge2.NumericGauge.ValueMarker.Callout.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.Ticks.SizeUnits = Steema.TeeChart.Store.Styles.PointerSizeUnits.Pixels;
      ...
      this.circularGauge2.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
    ...
    BitmapImage image = new BitmapImage(new Uri("ms-appx:///Resources/redline_warning.png"));

    private void revChart_BeforeDrawSeries(object sender, Steema.TeeChart.Store.Drawing.Graphics3D g)
    {
      if (warningOn) //display rev warning light
      {
        g.Draw(309, 213, image);
      }
    }
  }
}
