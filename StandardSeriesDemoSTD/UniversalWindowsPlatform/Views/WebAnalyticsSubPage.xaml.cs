...
namespace StandardSeries.Views
{
  ...
  /// </summary>
  public sealed partial class WebAnalyticsSubPage : Windows.UI.Xaml.Controls.Page
  {
    private Steema.TeeChart.Store.Styles.Donut donut3;
    private Steema.TeeChart.Store.Tools.Annotation annotation3;
    private Steema.TeeChart.Store.Styles.Donut donut2;
    private Steema.TeeChart.Store.Tools.Annotation annotation2;
    private Steema.TeeChart.Store.Styles.Line line1;
    private Steema.TeeChart.Store.Styles.Line line2;
    private Steema.TeeChart.Store.Styles.Line line3;
    private Steema.TeeChart.Store.Styles.Donut donut1;
    private Steema.TeeChart.Store.Tools.Annotation annotation1;
    private Steema.TeeChart.Store.Data.TextSource textSource1;
    ...
    private double InterpolateLineSeries(Steema.TeeChart.Store.Styles.Custom series, double xvalue)
    {
    ...
    private double InterpolateLineSeries(Steema.TeeChart.Store.Styles.Custom series, int firstindex, int lastindex, double xvalue)
    {
      int index;
