...
namespace StandardSeries.Views
{
  ...
  /// </summary>
  public sealed partial class MultiplePiesSubPage : Windows.UI.Xaml.Controls.Page
  {
    private Steema.TeeChart.Store.Styles.Bar bar3;
    private Steema.TeeChart.Store.Styles.Bar bar2;
    private Steema.TeeChart.Store.Styles.Pie pie3;
    private Steema.TeeChart.Store.Styles.Pie pie2;
    private Steema.TeeChart.Store.Styles.Pie pie1;
    private Steema.TeeChart.Store.Styles.Bar bar4;
    private Steema.TeeChart.Store.Styles.Bar bar5;
    private Steema.TeeChart.Store.Styles.Bar bar1;

    public MultiplePiesSubPage()
    {
    ...
    {
      this.bar3 = new Steema.TeeChart.Store.Styles.Bar();
      this.bar2 = new Steema.TeeChart.Store.Styles.Bar();
      this.pie3 = new Steema.TeeChart.Store.Styles.Pie();
      this.pie2 = new Steema.TeeChart.Store.Styles.Pie();
      this.pie1 = new Steema.TeeChart.Store.Styles.Pie();
      this.bar4 = new Steema.TeeChart.Store.Styles.Bar();
      this.bar5 = new Steema.TeeChart.Store.Styles.Bar();
      this.bar1 = new Steema.TeeChart.Store.Styles.Bar();
      ...
      this.tChart6.Axes.Left.AxisPen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(192)))), ((int)(((byte)(191)))), ((int)(((byte)(191)))));
      this.tChart6.Axes.Left.AxisPen.Width = 1;
      this.tChart6.Axes.Left.Grid.Visible = false;
      this.tChart6.Axes.Left.Increment = 20D;
      this.tChart6.Axes.Left.Labels.Font.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(128)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
      this.tChart6.Axes.Left.MinorTicks.Visible = false;
      this.tChart6.Footer.Font.Brush.Color = Windows.UI.Colors.Gray;
      this.tChart6.Header.Font.Brush.Color = Windows.UI.Colors.Gray;
      ...
      this.tChart6.Panel.Brush.Color = Windows.UI.Colors.White;
      this.tChart6.Panel.Brush.Gradient.EndColor = Windows.UI.Colors.White;
      this.tChart6.Panel.MarginBottom = 6D;
      this.tChart6.Series.Add(this.bar3);
      this.tChart6.TabIndex = 5;
      this.tChart6.Walls.Back.Brush.Gradient.EndColor = Windows.UI.Colors.White;
      this.tChart6.Walls.Visible = false;
      this.bar3.BarRound = Steema.TeeChart.Store.Styles.BarRounding.AtValue;
      this.bar3.BarWidthPercent = 95;
      this.bar3.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      this.bar3.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.bar3.Marks.Style = Steema.TeeChart.Store.Styles.MarksStyles.Value;
      this.bar3.OriginalCursor = null;
      this.bar3.Pen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(41)))), ((int)(((byte)(61)))), ((int)(((byte)(98)))));
      this.bar3.Title = "bar1";
      this.bar3.XValues.DataMember = "X";
      this.bar3.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      ...
      this.tChart5.Axes.Left.AxisPen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(192)))), ((int)(((byte)(191)))), ((int)(((byte)(191)))));
      this.tChart5.Axes.Left.AxisPen.Width = 1;
      this.tChart5.Axes.Left.Grid.Visible = false;
      this.tChart5.Axes.Left.Increment = 20D;
      this.tChart5.Axes.Left.Labels.Font.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(128)))), ((int)(((byte)(127)))), ((int)(((byte)(127)))));
      this.tChart5.Axes.Left.MinorTicks.Visible = false;
      this.tChart5.Footer.Font.Brush.Color = Windows.UI.Colors.Gray;
      ...
      this.bar2.BarRound = Steema.TeeChart.Store.Styles.BarRounding.AtValue;
      this.bar2.BarWidthPercent = 95;
      this.bar2.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      this.bar2.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.bar2.Marks.Style = Steema.TeeChart.Store.Styles.MarksStyles.Value;
      this.bar2.OriginalCursor = null;
      this.bar2.Pen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(41)))), ((int)(((byte)(61)))), ((int)(((byte)(98)))));
      this.bar2.Title = "bar1";
      this.bar2.XValues.DataMember = "X";
      this.bar2.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      ...
      this.pie3.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(243)))), ((int)(((byte)(156)))), ((int)(((byte)(53)))));
      this.pie3.Circled = true;
      this.pie3.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.pie3.MultiPie = Steema.TeeChart.Store.Styles.MultiPies.Automatic;
      this.pie3.OriginalCursor = null;
      this.pie3.OtherSlice.Color = Utils.EmptyColor;
      this.pie3.OtherSlice.Style = Steema.TeeChart.Store.Styles.PieOtherStyles.None;
      ...
      this.pie3.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      ...
      this.pie2.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(243)))), ((int)(((byte)(156)))), ((int)(((byte)(53)))));
      this.pie2.Circled = true;
      this.pie2.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.pie2.MultiPie = Steema.TeeChart.Store.Styles.MultiPies.Automatic;
      this.pie2.OriginalCursor = null;
      this.pie2.OtherSlice.Color = Utils.EmptyColor;
      this.pie2.OtherSlice.Style = Steema.TeeChart.Store.Styles.PieOtherStyles.None;
      ...
      this.pie2.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      ...
      this.pie1.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(243)))), ((int)(((byte)(156)))), ((int)(((byte)(53)))));
      this.pie1.Circled = true;
      this.pie1.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.tChart7.Footer.Font.Brush.Color = Windows.UI.Colors.Blue;
      this.tChart7.Header.Visible = false;
      this.tChart7.Legend.Alignment = Steema.TeeChart.Store.LegendAlignments.Top;
      this.tChart7.Legend.Font.Brush.Color = Windows.UI.Colors.Gray;
      ...
      this.tChart7.Panel.Bevel.Outer = Steema.TeeChart.Store.Drawing.BevelStyles.None;
      this.tChart7.Panel.Brush.Color = Windows.UI.Colors.White;
      this.tChart7.Panel.Brush.Gradient.EndColor = Windows.UI.Colors.White;
      ...
      this.tChart7.Walls.Back.Brush.Gradient.EndColor = Windows.UI.Colors.White;
      this.bar4.BarRound = Steema.TeeChart.Store.Styles.BarRounding.AtValue;
      this.bar4.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      this.bar4.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      this.bar4.ColorEach = false;
      this.bar4.Marks.Visible = false;
      this.bar4.OriginalCursor = null;
      this.bar4.Pen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(41)))), ((int)(((byte)(61)))), ((int)(((byte)(98)))));
      this.bar4.Pen.Visible = false;
      this.bar4.Title = "Women";
      this.bar4.XValues.DataMember = "X";
      this.bar4.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
      this.bar4.YValues.DataMember = "Bar";
      this.bar5.BarRound = Steema.TeeChart.Store.Styles.BarRounding.AtValue;
      this.bar5.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(243)))), ((int)(((byte)(156)))), ((int)(((byte)(53)))));
      this.bar5.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(243)))), ((int)(((byte)(156)))), ((int)(((byte)(53)))));
      this.bar5.ColorEach = false;
      this.bar5.Marks.Visible = false;
      this.bar5.OriginalCursor = null;
      this.bar5.Pen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(146)))), ((int)(((byte)(94)))), ((int)(((byte)(32)))));
      this.bar5.Pen.Visible = false;
      this.bar5.Title = "Men";
      this.bar5.XValues.DataMember = "X";
      this.bar5.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
    ...
    " in the evening class";
      ...
      this.bar1.BarRound = Steema.TeeChart.Store.Styles.BarRounding.AtValue;
      this.bar1.BarWidthPercent = 95;
      this.bar1.Brush.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      this.bar1.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(68)))), ((int)(((byte)(102)))), ((int)(((byte)(163)))));
      ...
      this.bar1.Marks.Style = Steema.TeeChart.Store.Styles.MarksStyles.Value;
      this.bar1.OriginalCursor = null;
      this.bar1.Pen.Color = Windows.UI.Color.FromArgb(255, ((int)(((byte)(41)))), ((int)(((byte)(61)))), ((int)(((byte)(98)))));
      this.bar1.Title = "bar1";
      this.bar1.XValues.DataMember = "X";
      this.bar1.XValues.Order = Steema.TeeChart.Store.Styles.ValueListOrder.Ascending;
