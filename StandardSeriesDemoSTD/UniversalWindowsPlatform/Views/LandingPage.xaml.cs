...
namespace StandardSeries.Views
{
  ...
  /// </summary>
  public sealed partial class LandingPage : Windows.UI.Xaml.Controls.Page
  {
    public LandingPage()
    {
    ...
    private void Donut_BeforeDrawValues(object sender, Steema.TeeChart.Store.Drawing.Graphics3D g)
    {
