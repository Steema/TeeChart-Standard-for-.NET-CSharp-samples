...
namespace StandardSeries.Views
{
  ...
  /// </summary>
  public sealed partial class ServerStatusSubPage : Windows.UI.Xaml.Controls.Page
  {
    public ServerStatusSubPage()
    {
    ...
    private void Calendar1_Change(Calendar sender, Calendar.CalendarChangeEventArgs e)
    {
      Random rnd1 = new Random();
    ...
    private void TChart1_AfterDraw(object sender, Steema.TeeChart.Store.Drawing.Graphics3D g)
    {
