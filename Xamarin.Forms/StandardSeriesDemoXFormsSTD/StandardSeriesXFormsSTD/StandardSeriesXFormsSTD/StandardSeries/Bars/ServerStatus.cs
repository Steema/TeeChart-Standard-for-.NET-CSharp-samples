...
namespace StandardSeriesXFormsSTD
{
	public class ServerStatus : ContentPage
    {
        ...
        {
          tChart1.Graphics3D.TextOut(tChart1.Axes.Bottom.CalcPosValue(0), horizBar1.CalcYPos(5) - 25, "Memory Usage");
          tChart1.Graphics3D.TextOut(tChart1.Axes.Bottom.CalcPosValue(0), horizBar1.CalcYPos(4) - 25, "CPU usage");
          tChart1.Graphics3D.TextOut(tChart1.Axes.Bottom.CalcPosValue(0), horizBar1.CalcYPos(3) - 25, "Storage space");
          tChart1.Graphics3D.TextOut(tChart1.Axes.Bottom.CalcPosValue(0), horizBar1.CalcYPos(2) - 25, "Apps installed");
          tChart1.Graphics3D.TextOut(tChart1.Axes.Bottom.CalcPosValue(0), horizBar1.CalcYPos(1) - 25, "Bandwidth");
        }
		...
		public ServerStatus ()
		{
            ...
            this.tChart2.Panning.Active = true;            
