...
This has been built as a Xamarin.Forms demo.
An image of the dashboard is selected and modified to make the backdrop image of our working Form. The image has been prepared, removing the scale from the tachometer and then removing the dial needles from both the tachometer and speedometer.
